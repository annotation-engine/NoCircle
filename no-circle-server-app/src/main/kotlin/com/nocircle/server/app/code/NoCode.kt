...
enum class NoCode(
	...
	USER_SEARCH_SUCCESS("搜索成功", 0),
	USER_SEARCH_USERNAME_NOT_EMPTY("用户名不能为空", 1040),
	USER_SEARCH_NOT_FOUND("未搜索到该用户", 1041),
	...
	FRIEND_VERSION_QUERY_SUCCESS("好友版本查询成功", 0),
	
	FRIEND_DETAIL_QUERY_SUCCESS("好友查询成功", 0),
	FRIEND_DETAIL_NOT_FOUND("好友查询失败", 1220),
	...
	FRIEND_REQUEST_QUERY_PENDING_COUNT_SUCCESS("查询成功", 0)
}